...
- **[backup_logical.sh](../scripts/backup_logical.sh)** : Effectue un dump SQL compressé.
...
- **[restore_logical.sh](../scripts/restore_logical.sh)** : Restaure une sauvegarde logique.
  - Utilisation : `./restore_logical.sh <galera|repli> <nom_fichier.sql.gz>`

### Sauvegarde Physique (MariaBackup)

- **[backup_physical.sh](../scripts/backup_physical.sh)** : Effectue une sauvegarde physique à chaud via MariaBackup.
...
- **[restore_physical.sh](../scripts/restore_physical.sh)** : Restaure une sauvegarde physique.
...
- **[gen_ssl.sh](../scripts/gen_ssl.sh)** : Génère une chaîne complète de certificats SSL (CA, Serveur et Client).
...
- **[setup_repli.sh](../scripts/setup_repli.sh)** : Automatise la mise en place de la réplication Maître/Esclave.
...
- **[test_lb_galera.sh](../tests/test_lb_galera.sh)** : Test léger de répartition de charge.
...
- **[test_perf_galera.sh](../tests/test_perf_galera.sh)** / **[test_perf_repli.sh](../tests/test_perf_repli.sh)** : Benchmarks de performance utilisant Sysbench.
